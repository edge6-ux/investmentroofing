...
const galleryImages = [
  {
    src: '/gallery/4f427673-1515-4ec1-9118-f865a21fa1b5.jpg',
    alt: 'Aerial drone shot of completed residential roof in North Georgia',
    category: 'residential',
    label: 'Residential Roofing',
  },
  {
    src: '/gallery/7a7ed954-37c4-4850-af61-23235c115d6b-1.jpg',
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-center gap-3 flex-wrap">
          {filters.map(({ label, value }) => (
            <button
              ...
              className={`px-6 py-2 text-sm font-semibold uppercase tracking-wider transition-all cursor-pointer rounded-none ${
                activeFilter === value
                  ? 'bg-brand-green text-black'
                  : 'bg-transparent border border-[#2a2a2a] text-gray-400 hover:border-brand-green hover:text-white'
              }`}
            >
              {label}
            </button>
